...
export default function ComponentDashboard() {
    return (
        <section className="bg-primary pt-24 sm:pt-32 pb-9">
            <article className="mx-auto max-w-7xl px-2 lg:px-10">
                <ComponentHeader />
                <div className="mx-auto place-items-center mt-7 grid max-w-2xl grid-cols-1 gap-8 pt-10 sm:mt-10 sm:pt-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
