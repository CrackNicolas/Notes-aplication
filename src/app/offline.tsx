    ...
    return (
        <section className="bg-primary pt-24 pb-9">
            <article className="flex flex-col items-center gap-y-4 max-w-7xl px-2 lg:px-10">
                ...
                <Link href={`${process.env.DEVELOPMENT_DOMAIN}/dashboard/main`} title="Reintentar" className="border-[0.1px] border-secondary px-2 py-1 b rounded-md hover:bg-secondary hover:text-primary bg-primary text-secondary text-center text-md tracking-wide">
                    Reintentar
                </Link>
            </article>
        </section>
